        ...
        <form onSubmit={handleUpdateProfile} className="surface-glass rounded-3xl border border-zinc-200/80 dark:border-white/10 p-5 sm:p-7 shadow-xl shadow-slate-200/40 dark:shadow-black/10 space-y-5">
          ...
          <div className="space-y-1">
            ...
            <textarea
              ...
              rows={2}
              maxLength={40}
              className="w-full px-3.5 py-2 rounded-xl border border-zinc-200 bg-white/90 text-zinc-900 shadow-xs placeholder-zinc-400 focus:outline-none focus:border-sky-500 focus:ring-2 focus:ring-sky-500/20 transition-all duration-200 text-sm dark:border-white/10 dark:bg-black/10 dark:text-zinc-100 dark:placeholder-zinc-500 resize-none"
              disabled={loading || uploading}
            />
            <div className="flex items-center justify-between px-1 text-[11px] text-zinc-400 dark:text-zinc-500">
              ...
              <span className={bio.length >= 40 ? "text-amber-500 font-semibold" : ""}>{bio.length}/40</span>
            </div>
          </div>
